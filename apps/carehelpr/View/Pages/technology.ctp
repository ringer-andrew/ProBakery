<section>
        ...
        <div class="tech-banner">
            <div class="container-fluid">
                <div class="row-fluid">
                    <div class="span3"> </div>
                    <div class="span8 tech-box">
                         <div class="container-fluid">
                             <div class="row-fluid">                        
                         
                                 <div class="span6">
                                 <div class="tech-heading">
                                 <span id="tech-heading1">Care</span>
                                 <span id="tech-heading2">Helpr</span>
                                 </div>   
                         
                             <p class="tech-subheading">Empowering Homecare practitioners across North America</p>
                             <p class="tech-punchline">Lorem Ipsum is simply dummy text of the<br>
	...
	<div class="container-fluid">
                 ...
                 <div class="span8">
                     ...
                     <p class="roi-text color">Lorem Ipsum is simply dummy text of the printingand<br>
                          ...
                          <div class="row-fluid">   
                             ...
                             <h3 class="roi-keypoints">Lorem Ipsum</h3>
                             <p class="roi-keypoints color">ipsum dolores est.Est<br>
                                dolorum
                             </p>   
      ...
      <div class="container-fluid">       
           <div class="row-fluid">  
                ...
                <div class="span8">    
                    ...
                    <span id="help2">1(800)296-7184</span>
                    </div>               
                 </div>
     ...
     <div id="tech-section1">
       <div class="container-fluid">   
          <div class="row-fluid tech-idea">
              
              <div class="span3"></div>
              <div class="span7 tech-doublefont1" >
      ...
      <div class="container-fluid">
           <div class="row-fluid">
                 ...
                 <div class="span1"></div>
                 <div class="span5">
                  <p class=" tech-align">Lorem Ipsum is simply dummy text of theprinting and<br> 
                  ...
                  <ul>
                     ...
                     <a class="btn btn-large btn-info" href="#"> Watch Video </a>
...
<div id="tech-section2">
       <div class="container-fluid">   
          <div class="row-fluid tech-idea">
              
              <div class="span3"></div>
              <div class="span7 tech-doublefont2" >
                  <span id="lorem2"> Lorem </span>
                  <span id="lorem-text2">is simply dummy text that you put on here</span>                
             </div>
             <div class="span2"></div>
      ...
      <div class="container-fluid">
           <div class="row-fluid">
                 ...
                 <div class="span6"></div>
                 <div class="span5">
                  <p class=" tech-align2">Lorem Ipsum is simply dummy text of theprinting and<br> 
                                        typesetting industry.Lorem Ipsum has been the<br> 
                                        industry's standard dummy text ever since the 1500s.</p>
...
<section>
      ...
      <div class="row-fluid form tech-lowerbackground">
